...
import PuppyWar.game.Game;
import PuppyWar.menus.EndGamePanel;
import PuppyWar.menus.StartMenuPanel;
...
public class Launcher {
    ...
    public Launcher(){
        ...
        this.jf.setTitle("Puppy War"); // setting the title of the JFrame window.
